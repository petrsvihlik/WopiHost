...
/// signal: the WOPI endpoints already short-circuit on locks before reaching the storage
/// layer, so this exception only surfaces when a non-WOPI code path or future endpoint
