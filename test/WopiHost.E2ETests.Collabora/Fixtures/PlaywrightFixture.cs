...
/// dependency graph onto SmokeTests for no benefit. The two files are ~40 lines each.
/// </para>
/// </remarks>
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        if (exitCode != 0)
        {
            throw new InvalidOperationException(
                ...
                "Run 'pwsh test/WopiHost.E2ETests.Collabora/bin/Debug/net10.0/playwright.ps1 install chromium' manually.");
        }
