...
Running the application only makes sense with a WOPI client as its counterpart. WopiHost is compatible with the following clients:
 ...
 - Office Online Server 2016 ([deployment guidelines](https://learn.microsoft.com/officeonlineserver/deploy-office-online-server))
 - Office Online https://learn.microsoft.com/microsoft-365/cloud-storage-partner-program/online/
