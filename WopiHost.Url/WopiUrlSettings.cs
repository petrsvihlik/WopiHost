...
{
    /// <summary>
    /// Additional URL settings influencing the behavior of the WOPI client (as defined in http://wopi.readthedocs.io/en/latest/discovery.html#placeholder-values).
